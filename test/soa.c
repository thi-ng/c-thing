...
int test_soa() {
  ...
  CT_IS(0 == ct_array_compare_f32(xa, FVEC(11, 12, 13, 14), CT_EPS, NUM),
        "add1fpx");
  CT_IS(0 == ct_array_compare_f32(ya, FVEC(21, 22, 23, 24), CT_EPS, NUM),
        "add1fpy");
  ...
  ct_soa_min_imm(&a, &b);
  CT_IS(0 == ct_array_compare_f32(xa, xb, CT_EPS, NUM), "min x");
  CT_IS(0 == ct_array_compare_f32(ya, yb, CT_EPS, NUM), "min y");
  ...
  reset_soa2(&a, &b);
  ct_soa_dot2(&a, &b, xa);
  CT_IS(0 == ct_array_compare_f32(xa, FVEC(20, 80, 180, 320), CT_EPS, NUM),
        "dot2");

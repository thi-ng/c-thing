...
void* ct_ht_get(CT_Hashtable* t, const void* key, uint32_t ks, uint32_t* vs);
int ct_ht_contains(CT_Hashtable* t, const void* key, uint32_t ks);
...
void* ct_ht_update(CT_Hashtable* t, const void* key, uint32_t ks,

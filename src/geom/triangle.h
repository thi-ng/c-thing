...
CT_Triangle2f *ct_triangle2f_init(CT_Triangle2f *t,
                                  const CT_Vec2f *a,
                                  const CT_Vec2f *b,
                                  const CT_Vec2f *c);
...
CT_Vec2f *ct_triangle2f_point_opposite_ptr(CT_Triangle2f *t,
                                           const CT_Vec2f *a,
                                           const CT_Vec2f *b);
CT_Vec2f *ct_triangle2f_point_opposite(CT_Triangle2f *t,
                                       const CT_Vec2f *a,
                                       const CT_Vec2f *b);

///// CT_Triangle3f

CT_Triangle3f *ct_triangle3f_init(CT_Triangle3f *t,
                                  const CT_Vec3f *a,
                                  const CT_Vec3f *b,
                                  const CT_Vec3f *c);
...
CT_Vec3f *ct_triangle3f_normal(const CT_Triangle3f *t,
                               CT_Vec3f *out,
                               size_t normalize);
...
CT_Vec3f *ct_triangle3f_point_opposite_ptr(CT_Triangle3f *t,
                                           const CT_Vec3f *a,
                                           const CT_Vec3f *b);
CT_Vec3f *ct_triangle3f_point_opposite(CT_Triangle3f *t,
                                       const CT_Vec3f *a,
                                       const CT_Vec3f *b);

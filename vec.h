...
CT_Vec2f *ct_add2fn(CT_Vec2f *v, float n, CT_Arena* arena);
CT_Vec2f *ct_add2fn_imm(CT_Vec2f *v, float n);
CT_Vec2f *ct_add2fxy(CT_Vec2f *v, float x, float y, CT_Arena* arena);
...
CT_Vec3f *ct_add3fxyz(CT_Vec2f *v, float x, float y, float z, CT_Arena* arena);
